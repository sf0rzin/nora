...
|---|---|---|---|
| US05 | SSO Entra ID / SAML | Demo Plano A fechada OU 100 tenants Plano B | Anthony (decisão comercial) |
...
| US47 | MCP project state (Won't) | Plano B integração | Anthony |
...
- Anthony e arquitetos focam em **polir o que existe** vs adicionar features que ninguém vê no MVP
...
**Negativas:**
- Anthony pode sentir tentação de "só essa eu adiciono" — disciplina precisa ser ativa
...
1. **Continuar expandindo backlog** — rejeitado pela razão do contexto (velocidade insustentável + fadiga solo + sinal visual "incompleto")
...
|---|---|---|
| 2026-05-14 | Anthony Sforzin (PO) | Aprovado em bloco após revisão do Arquiteto Design + recomendação Tech Lead. Critério reativação documentado por US |
