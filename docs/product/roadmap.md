...
Every row here is decided by an accepted ADR. Delivered rows are struck through and kept rather than removed — what this table records is the decision, not the queue. Per-story status stays in
