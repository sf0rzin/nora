...
|---|---|---|
| Sub-phase closed (PR merged, feature deployed) | `Claude/00-design-diary/` | `YYYY-MM-DD-subphase-X.Y-done.md` or `YYYY-MM-DD-<theme>.md` |
| Decision between technical alternatives (no formal ADR yet) | `Claude/10-tradeoffs-pendentes/` | `<theme>.md` |
| Lesson learned from an incident | `Claude/20-lessons-learned/` | `YYYY-MM-DD-<short-incident>.md` |
| **Cross-architect message** | `Claude/50-coordenacao-arquitetos/` | `YYYY-MM-DD-from-<you>-to-<other>-<theme>.md` |
| Briefing for the Desktop teammate | `Claude/40-desktop-handoff/` | `YYYY-MM-DD-<update-name>.md` |
...
```markdown
# Note title
**From:** <your-identity — primary area>
**To:** <other-architect — primary area>
**Date:** YYYY-MM-DD
**Channel:** Obsidian vault, async (Stratfy relays)
**Status:** review | proposal | decision | information
**Prerequisites:** <earlier docs they need to have read>
```
...
Slice N — <title>
  ...
  Scope: <absolute paths or module>
  Suggested branch: feat/sub-X.Y-<slug> or feat/usZZ-<slug>
  Task: <self-contained instruction for the subagent>
...
6. Create an initial note in the vault: `Claude/50-coordenacao-arquitetos/YYYY-MM-DD-architect-<area>-onboarded.md` introducing yourself to the others
