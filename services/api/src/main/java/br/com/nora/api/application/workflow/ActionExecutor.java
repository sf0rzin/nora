 ...
 *
 * <p>Contract: success returns a short pt-BR message for the execution log (the log is rendered
 * in the product UI, which is pt-BR). Failure MUST propagate an exception — the {@link
 * WorkflowEngine} catches it, records it in the log and marks the execution as FAILED. Never fake
 * success.
 */
