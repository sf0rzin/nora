...
/**
 * NORA Flows "Send email via Gmail" action — sends FROM the tenant's connected GOOGLE ACCOUNT (real
 * OAuth), unlike {@code send_email} (Resend, NORA as sender). Params: {@code to} (required),
