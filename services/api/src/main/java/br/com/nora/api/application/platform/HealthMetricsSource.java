 ...
 *
 * <p>Agnóstica de backend de propósito: o adaptador em produção é o {@code
 * PrometheusHealthSource} (ADR 0034); antes era o App Insights REST query API. Trocar a fonte
 * não pode mudar o contrato — {@link HealthSnapshot} é o mesmo record para qualquer adaptador.
 */
